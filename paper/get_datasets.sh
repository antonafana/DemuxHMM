...
wget -O data_dir/v2_fca_biohub_head_10x_raw.h5ad "https://cloud.flycellatlas.org/index.php/s/RAGbG59qwaLKqEF/download?path=%2F&files=v2_fca_biohub_head_10x_raw.h5ad"
wget -O data_dir/v2_fca_biohub_body_10x_raw.h5ad "https://cloud.flycellatlas.org/index.php/s/RAGbG59qwaLKqEF/download?path=%2F&files=v2_fca_biohub_body_10x_raw.h5ad"
